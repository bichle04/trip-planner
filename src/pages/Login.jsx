                ...
                <div className='bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl border-2 border-gray-300'>
                    <form onSubmit={handleLogin} className='space-y-6'>
                        ...
                        <div className='flex items-center justify-between'>
                            ...
                            <div className='text-sm'>
                                <Link to='/forgot-password' className='font-medium text-[var(--color-primary)] hover:text-[var(--color-primary-emphasis)]'>
                    ...
                    <div className='mt-6 text-center'>
                        <p className='text-sm text-[var(--color-muted)]'>
                            ...
                            <Link to='/signup' className='font-medium text-[var(--color-primary)] hover:text-[var(--color-primary-emphasis)]'>
                                Sign up now
                            </Link>
                        </p>
                    </div>
